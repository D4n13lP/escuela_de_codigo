...
¿Cuáles de los siguientes son nombres de variables válidos? (valor 0.3 por cada uno)
    ...
    5. 1                                 TIPO DE DATO ENTERO

    6. thing1                            VALIDO

    7. 1thing                            NO PUEDE COMENZAR CON UN NUMERO

    8. ONE-HUNDRED                       SUPERA EL TAMAÑO MAXIMO

    9. ONE_HUNDRED                       SUPERA EL TAMAÑO MAXIMO

    10. something2do                     SUPERA EL TAMAÑO MAXIMO
